...
#define LED_BUZZER_DURATION_1500MS	(LED_BUZZER_DURATION_50MS * 30)
#define LED_BUZZER_DURATION_2000MS	(LED_BUZZER_DURATION_50MS * 40)
#define LED_BUZZER_DURATION_3000MS	(LED_BUZZER_DURATION_50MS * 60)
